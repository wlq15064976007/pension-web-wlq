<template>
  <div class="app-container">
    <div class="head" style="height: 40px;">
      <span style="font-size:18px;padding-left:5xp;font-weight:bold;margin-left:10px;">换床转区</span>
    </div>
         ...
         <div class="bed-info" style="padding:14px;">
          <div>
            <el-tabs v-model="activeName" @tab-click="handleClick">
              <el-tab-pane label="选择新床位" name="1">
...
import changeBedForm from '../bed-manager/change-bedcopy'
