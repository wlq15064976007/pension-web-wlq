  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-form :inline="true" :model="listQuery" class="form-inline">
        ...
        <el-form-item>
          <el-button v-waves type="primary" icon="el-icon-refresh" size="small" @click="handleFilterClear">新增预订</el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    >
      ...
      <el-table-column label="预约床位" min-width="150px">
        <template slot-scope="scope">
          {{ scope.row.buildingName + scope.row.floorName + scope.row.bedName }}
        </template>
      </el-table-column>
      <el-table-column label="预计入住时间" min-width="90px">
        <template slot-scope="scope">
