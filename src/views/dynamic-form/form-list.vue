  ...
  <div class="app-container">
    <el-row>
      ...
      <el-col :span="20">
        ...
        <!-- 表单 -->
        <nursingLevelForm ref="formNursingLevel" :org-id="listQuery.orgId" @updateRow="updateRow" />
      </el-col>
    </el-row>
  </div>
</template>
...
<script>
import { findPage, del, edit, delAll } from '@/api/nursinglevel'
import { loginUserOrg } from '@/api/org'
import waves from '@/directive/waves'
import { pickerOptions, getArrByKey } from '@/utils'
import nursingLevelForm from './form'

export default {
  name: 'NursingLevel',
  components: { nursingLevelForm },
  directives: {
    waves
  },
  filters: {
